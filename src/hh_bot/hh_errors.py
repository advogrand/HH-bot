...
_KNOWN_MESSAGES = {
    ...
    "forbidden": "hh.ru API denied this operation. Reconnect hh.ru or use browser-assisted mode if API access is unavailable.",
    "network_error": "Network error while calling hh.ru API. Try again later.",
